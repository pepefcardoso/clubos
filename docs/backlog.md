...
**Fase 2: UI e Componentes Desacoplados (Podem ser paralelizados com a Fase 1)** 7. `T-099` — Módulo OFX (Upload, Parser e Match) 8. `T-095` — Carteirinha Digital 9. `T-100` — Painel SAF
