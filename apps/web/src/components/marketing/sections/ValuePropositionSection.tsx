  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-stretch max-w-5xl mx-auto">
          <div className="bg-white rounded-3xl border border-neutral-200 shadow-sm p-8 sm:p-10 flex flex-col relative overflow-hidden animate-in fade-in slide-in-from-left-8 duration-700 delay-200 fill-mode-both">
            ...
            <div className="relative z-10 mb-8">
              ...
              <p className="text-neutral-500 leading-relaxed text-sm">
                Perder horas a cruzar quem pagou com quem não pagou, mandar
                mensagens manuais no WhatsApp e atualizar planilhas que nunca
                batem certo.
              </p>
            </div>
            ...
            <div className="mt-auto bg-neutral-50 border border-neutral-200 rounded-xl p-4 transform rotate-1 shadow-inner">
              <div className="flex items-center gap-2 mb-3 pb-3 border-b border-neutral-200">
                ...
                <span className="text-xs font-semibold text-neutral-600">
                  Controle_Mensalidades_Final_v3.xlsx
                </span>
              </div>
              <div className="space-y-2">
                {[
                  ...
                  },
                  {
                    ...
                    valor: "R$ 80,00",
                    status: "Atrasado!!",
                    cor: "text-danger font-bold",
                  },
                  {
                    nome: "Ana Costa",
                    valor: "R$ 80,00",
                    status: "Mandar msg",
                    cor: "text-warning font-bold",
                  },
                ].map((row, i) => (
                  <div
                    key={i}
                    className="flex justify-between items-center text-xs p-2 bg-white border border-neutral-100 rounded shadow-sm"
                  >
                    <span className="text-neutral-700 w-1/3 truncate">
                      {row.nome}
                    </span>
                    <span className="font-mono text-neutral-500 w-1/3 text-center">
                      {row.valor}
                    </span>
                    <span className={cn("w-1/3 text-right", row.cor)}>
                      {row.status}
                    </span>
                  </div>
                ))}
          ...
          <div className="bg-neutral-900 rounded-3xl border border-neutral-800 shadow-xl p-8 sm:p-10 flex flex-col relative overflow-hidden animate-in fade-in slide-in-from-right-8 duration-700 delay-500 fill-mode-both">
            ...
            <div className="relative z-10 mb-8">
              ...
              <p className="text-neutral-400 leading-relaxed text-sm">
                O sistema trabalha por si. A cobrança é gerada, o sócio é
                avisado e a baixa é automática. Foco no clube, não na
                burocracia.
              </p>
            </div>
            ...
            <div className="mt-auto space-y-4 relative before:absolute before:inset-y-4 before:left-[19px] before:w-px before:bg-neutral-800">
              ...
              <div className="flex gap-4 relative z-10">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-xs text-neutral-500 mt-0.5">
                    Sócio recebe lembrete com QR Code no WhatsApp.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4 relative z-10">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-xs text-primary-300 mt-0.5">
                    Pix pago e conciliação automática feita.
                  </p>
                </div>
              </div>
            </div>
